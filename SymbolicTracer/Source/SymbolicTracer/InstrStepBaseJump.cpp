...
void UInstrStepBaseJump::NativeOnListItemObjectSet(UObject* ListItemObject)
{
	UE_LOG(STLog, Warning, TEXT("InstrStepBaseJump NativeOnListItemObjectSet called:"));
