...
#include "InstrStepBaseBranch.generated.h"
 ...
 */
UCLASS(Abstract)
class SYMBOLICTRACER_API UInstrStepBaseBranch : public UWidgetSTBase, public IUserObjectListEntry
{
	GENERATED_BODY()
...
public:
	...
	// shows the target of the step
	UPROPERTY(BlueprintReadOnly, Category="instruction step", meta=(BindWidget))
	TObjectPtr<UTextBlock> ConditionText = nullptr;
