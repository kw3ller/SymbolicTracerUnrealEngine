...
void ULoadBase::OnRunInstrIndexChange(int NewRunInd, int NewInstrInd, int NewStepInd, int NewScrollStepId)
{
...
void ULoadBase::Init(ARTSPlayerPawnST* PlayerChar)
{
...
void ULoadBase::NativeOnInitialized()
{
...
#if WITH_EDITOR
void ULoadBase::OnDesignerChanged(const FDesignerChangedEventArgs& EventArgs)
{
...
void ULoadBase::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
